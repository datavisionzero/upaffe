...
builder.Services.AddScoped<ReadInstanceOverview>();
builder.Services.AddScoped<ReadMonitorInventory>();
...
builder.Services.AddScoped<ReadHttpCheckEvidence>();
builder.Services.AddScoped<ListIncidentHistory>();
builder.Services.AddScoped<ReadHttpIncidentEvidence>();
...
builder.Services.AddScoped<ReadPushReportEvidence>();
